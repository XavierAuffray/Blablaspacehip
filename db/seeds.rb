...
# Creates all planets and assigns photo via url
...
j1 = Journey.create(departure: p1.name, arrival: p5.name, driver: d1, photo: p5.photo, price: 5000, available_seats: 26, spaceship_name: "Moon Express", date: DateTime.parse('2020-03-14T07:00:00'))
j2 = Journey.create(departure: p1.name, arrival: p3.name, driver: d2, photo: p3.photo, price: 150000, available_seats: 0, spaceship_name: "New World", date: DateTime.parse('2020-03-14T07:00:00'))
j3 = Journey.create(departure: p2.name, arrival: p8.name, driver: d1, photo: p8.photo, price: 1400, available_seats: 1, spaceship_name: "Space Explorer", date: DateTime.parse('2020-03-14T07:00:00'))
j4 = Journey.create(departure: p7.name, arrival: p1.name, driver: d1, photo: p1.photo, price: 8999, available_seats: 68, spaceship_name: "Rucket", date: DateTime.parse('2020-03-14T07:00:00'))
